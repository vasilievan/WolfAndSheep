...
class WolfAI(private val sheep: Sheep, private val wolves: MutableList<Wolf>) : AI {
    ...
    */
    ...
    Выбираю ход, при котором овечке дольше всего бежать до точки невозврата (максимальная глубина
    рекурсии при BFS). И хожу так. Очевидно, есть исключения, но их всего 20. Обрабатываю отдельно.
